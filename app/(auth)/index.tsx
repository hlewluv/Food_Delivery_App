...
export default function Index() {
  return <Redirect href="/(tabs)/home" />; // Mở thẳng vào tab home
  return (
    <ImageBackground
      ...
      <View className='absolute bottom-[8%] w-full px-10'>
        ...
        <View className='flex-row justify-center'>
          <Text className='text-base font-semibold text-white'>Already have an account? </Text>
          <TouchableOpacity onPress={() => router.push('/login')}>
            <Text className='text-base font-[800] text-primary'>Login</Text>
          </TouchableOpacity>
        </View>
      </View>
    </ImageBackground>
