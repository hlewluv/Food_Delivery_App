                ...
                <View className="w-1/3 pr-4 flex justify-start pt-10">
                  <View className="items-center" style={{ marginTop: 20 }}>
                    <View className="relative mb-2">
                      <Image
                        source={{ uri: editDishData.image || 'https://via.placeholder.com/200x160' }}
                ...
                >
                  <View style={{ marginBottom: 16 }}>
                    ...
                    <TextInput
                      ...
                      onChangeText={(text: string) => setEditDishData({ ...editDishData, name: text })}
                    />
                  </View>
                  <View style={{ marginBottom: 16 }}>
                    <Text style={{ fontSize: 14, fontWeight: '500', color: '#374151', marginBottom: 4 }}>
                    ...
                    <TextInput
                      ...
                      onChangeText={(text: string) => setEditDishData({ ...editDishData, description: text })}
                      multiline
                    />
                  </View>
                  <View style={{ marginBottom: 16 }}>
                    ...
                    <TextInput
                      ...
                      onChangeText={(text: string) => setEditDishData({ ...editDishData, price: text })}
                  ...
                  >
                    <Text style={{ fontSize: 14, fontWeight: '500', color: '#374151' }}>Trạng thái:</Text>
                    <TouchableOpacity
                      onPress={() => setEditDishData({ ...editDishData, available: !editDishData.available })}
                      style={{
                  ...
                  <View style={{ flexDirection: 'row', gap: 12 }}>
                    ...
                    >
                      <Text style={{ color: 'white', fontWeight: '500', fontSize: 14 }}>Lưu thay đổi</Text>
                    </TouchableOpacity>
                    {selectedDish && (
                      <TouchableOpacity
                        onPress={deleteDish}
                      ...
                      >
                        <Text style={{ color: 'white', fontWeight: '500', fontSize: 14 }}>Xóa món</Text>
                      </TouchableOpacity>
                    )}
                  </View>
                </ScrollView>
